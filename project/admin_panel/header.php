<?php
    ...
    $hed = "select * from admin_data where`name`='$name'";
    $hedqu1=mysqli_query($con,$hed);
    $hedqu2=mysqli_fetch_array($hedqu1);
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title"><?php if ($hedqu2['logtip']=='admin') {
                        echo "admin";
                    }else{
                        echo "meneger";
                    } ?></li><!-- /.menu-title -->
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/newimages/<?php echo $hedqu2['image']; ?>" alt="User Avatar">
                        </a>
