<?php
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        {
            $id=$_GET['ad_id'];
            $qu="select * from photo where`photo_id`='$id'";
        ...
        $sql = "UPDATE `photo` SET `titel` = '$titel', `content` = '$contents', `image` = '$image'  where `photo_id`='$id'";
        ...
        {
            $sql = "INSERT INTO `photo` (`titel`, `content`, `image`) VALUES ('$titel', '$contents', '$image')";
            mysqli_query($con,$sql);
        }
    }
    if (!empty($_GET['ad_id'])) 
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <?php }else{ ?>
                                <input type="submit" name="submit" class="btn btn-success btn-sm"> 
                            <?php } ?>    
                                <a class="btn btn-primary btn-sm" href="photo-forms.php">Reset</a>
                            </div>
                                </form>
                        </div>
                    </div>
